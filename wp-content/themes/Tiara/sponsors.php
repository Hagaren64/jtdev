...
<li>
<?php 
	$ban1 = get_option('tiar_banner1'); 
	$url1 = get_option('tiar_url1'); 
	$lab1 = get_option('tiar_lab1'); 
	$alt1 = get_option('tiar_alt1');
?>
...
<li>
<?php 
	$ban2 = get_option('tiar_banner2'); 
	$url2 = get_option('tiar_url2'); 
	$lab2 = get_option('tiar_lab2'); 	
	$alt2 = get_option('tiar_alt2');
?>
...
<li>
<?php 
	$ban3 = get_option('tiar_banner3'); 
	$url3 = get_option('tiar_url3'); 
	$lab3 = get_option('tiar_lab3'); 
	$alt3 = get_option('tiar_alt3');	
?>
...
<li>
<?php 
	$ban4 = get_option('tiar_banner4'); 
	$url4 = get_option('tiar_url4');
	$lab4 = get_option('tiar_lab4'); 
	$alt4 = get_option('tiar_alt4');	
?>
